...
![민감 키 노출 — 공개용 마스킹](screenshots/redacted/01-sensitive-keys-redacted.png)
...
![RBAC 권한 검증 — 공개용 마스킹](screenshots/redacted/02-rbac-redacted-v2.png)
...
![NodePort 구성 — 공개용 마스킹](screenshots/redacted/03-nodeport-redacted.png)
...
![Namespace 간 Redis 접근 — 공개용 마스킹](screenshots/redacted/04-namespace-redacted.png)
...
![컨테이너 탈출 위험 구성 검증](screenshots/redacted/05-container-escape.png)
